              ...
              children: [
                ...
                Padding(
                  ...
                  child: TextFormField(
                    ...
                    controller:
                        registerProvider.dateOfBirthController.controller,
...
//               ),
                ...
                Padding(
                  ...
                  child: TextFormField(
                    controller:
                        registerProvider.phoneNumberController.controller,
                    validator: (value) {
                      if (value!.isEmpty) {
                        return 'Please enter phone number';
                      }
                ...
                Padding(
                  ...
                  child: TextFormField(
                    controller:
                        registerProvider.collageStateController.controller,
                    validator: (value) {
                      if (value!.isEmpty) {
                        return 'Please enter collage state';
                      }
                ...
                Padding(
                  ...
                  child: TextFormField(
                    controller:
                        registerProvider.collageNameController.controller,
                    validator: (value) {
                      if (value!.isEmpty) {
                        return 'Please enter collage name';
                      }
                ...
                Padding(
                  ...
                  child: TextFormField(
                    controller:
                        registerProvider.branchNameController.controller,
                    validator: (value) {
                      if (value!.isEmpty) {
                        return 'Please enter branch';
                      }
                ...
                Padding(
                  ...
                  child: TextFormField(
                    controller:
                        registerProvider.passingYearController.controller,
                    validator: (value) {
                      if (value!.isEmpty) {
                        return 'Please enter passing year.';
                      }
